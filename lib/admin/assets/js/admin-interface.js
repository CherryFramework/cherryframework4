...
jQuery(document).ready(function() {
	...
	if( jQuery('.cherry-options-loader').length == 0 ){
		jQuery('body').append('<div class="cherry-options-loader"><span></span></div>');
		ajaxLoaderContainer = jQuery('.cherry-options-loader');
	}
