		...
		init : function( options ) {
			...
			return this.each(function(){
				...
				function createNewGroup(){
					...
					,	selectedPriority = $(':selected', staticSelector).data('position')
					...
					nameKeyPriority = dataName + '[' + selectedValue + '][options][position]';
					$('.ui-accordion-content .key-position', newGroup).attr({'name': nameKeyPriority, 'value': selectedPriority});
