    ...
    var methods = {
        init : function( options ) {
            ...
            return this.each(function(){
                ...
                var 
                    $this = $(this)
                ,	AddButton = $('.addNewBtn', this)
                ,	accordionUnit = $('.accordion-unit', this)
                ,	groupList = $('.accordion-unit > .group', this)
                ;
                ...
                function addEventsFunction(){
				    $('.cherry-accordion-wrap .select-static').on('change', function(){
				    	$(this).parent().parent().siblings('.ui-accordion-header').find('span.label').text($(':selected', this).text());
				    	$(this).parent().siblings('.itemname').val($(':selected', this).text());
                ...
                function addNewGroup(){
					...
					newGroup = $(groupList).filter(':last').clone();
