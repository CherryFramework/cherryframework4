		...
		jQuery('.upload-button').on('click', function () {
			...
			cherry_uploader.on('select', function() {
				...
				while(attachment[count]){
					...
					new_img += '<div class="cherry-image-wrap"><img  src="' +img_src+ '" alt="" data-img-attr="'+return_data+'"><a class="cherry-remove-image" title=""><i class="dashicons dashicons-no"></i></a></div>';
