(function( $ ) {
	...
	$.cherryInterfaceBuilder.CallInterfaceBuilder = function( target ) {
		...
		// init Stepper
		$.uiElements.UIStepper.init( target );
		// init Switcher
		$.uiElements.UIswitcher.init( target );
		// init Slider
		$.cherryInterfaceBuilder.initSliderElement( target );
		// init Range Slider
		$.cherryInterfaceBuilder.initRangeSliderElement( target );
		// init Checkbox
		$.cherryInterfaceBuilder.initCheckboxElement( target );
		// init Image radio
		...
		// init Ace Editor
		$.cherryInterfaceBuilder.initAceEditorElement( target );
		// init filter-select
	...
	// ---------- Checkbox -------------------------------------------------------------------
	$.cherryInterfaceBuilder.initCheckboxElement = function( target ){
		$('.cherry-checkbox-item', target).on('click', function(event){
			$( this ).siblings('.cherry-input[type="checkbox"]').trigger('click');
		})
		$('.cherry-input[type="checkbox"]', target).on('change', function(event){
			var
	...
	$.cherryInterfaceBuilder.initTypographyElement = function( target ){
		...
		function change_font(item){
			var
				parent_wrap = item.parents('.cherry-typography')
	...
	// ---------- Ace Editor ------------------------------------------------------------------
	$.cherryInterfaceBuilder.initAceEditorElement = function( target ){
