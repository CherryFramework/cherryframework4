...
jQuery(document).ready(function() {
	...
	// static_editor
    jQuery('.cherry-accordion-wrap').cherryStaticEditor();
    // static_editor
    ...
    var methods = {
        init : function( options ) {
            ...
            return this.each(function(){
                ...
                var 
                    _this = $(this)
                ,	addStaticButton = $('.addNewBtn', _this)
                ...
                function addEventsFunction(){
                	...
                	$('.delete-group', _this).on('click', function(){
                		if( !$(this).hasClass('confirmState') ){
                			$(this).addClass('confirmState');
                		}else{
                			//$(this).removeClass('confirmState');
                		}
                		return false;
                	});
                	$('.confirmBtn', _this).on('click', function(){
                		deleteGroup( $(this).parent() );
                	});
                	$('.cancleBtn', _this).on('click', function(){
                ...
                function mouseLeaveEvent(group){
                	$('.delete-group', group).removeClass('confirmState');
                }
                ...
                function createNewGroup(){
                	...
                	$('.confirmBtn', newGroup).on('click', function(){
                		deleteGroup( $(this).parent() );
                	});
                	$('.cancleBtn', newGroup).on('click', function(){
                		$(this).parent().removeClass('confirmState');
                		return false;
                	});
                	...
                	accordionUnit.append(newGroup).accordion( "refresh" );
                	updateStaticSelector();
                }// end createNewGroup	
                ...
                function deleteGroup(deleteButton){
					...
					$('.confirmBtn', deleteButton).off('click');
					$('.cancleBtn', deleteButton).off('click');
...
/*(function($){
    ...
    $.fn.cherryStaticAreaEditor = function( method ){ 
        if ( methods[method] ) {
            return methods[method].apply( this, Array.prototype.slice.call( arguments, 1 ));
        } else if ( typeof method === 'object' || ! method ) {
            return methods.init.apply( this, arguments );
