...
(function( $ ) {
	...
	$.uiElements.UIStepper = $.uiElements.UIStepper || {};

	$.uiElements.UIStepper.init = function( target ) {
		$('.step-up', target).on('click', function () {
			...
			;
			console.log("input_value "+values['input_value']);
			console.log("step_value "+values['step_value']);
